...
def dataset():
    ...
    This function count compute 12 geometric features,
    note result in  file data_set_geometric_features.csv

    """""


    mypath_in = 'part_start'
    mypath_late = 'part_start_late'
    ...
    with open('data_set_geometric_features.csv', 'w', newline='') as f:
