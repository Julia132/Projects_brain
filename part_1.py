...
def dataset():
    ...
    mypath_contour = 'C:/Users/inet/Desktop/part_1'
    ...
    onlyfiles_out = [f for f in listdir(mypath_part_0) if isfile(join(mypath_part_0, f))]
    ...
    with open('data_set_new.csv', 'w', newline='') as f:
            ...
            for n in range(0, len(onlyfiles_out)):
                ...
                img[n] = cv2.imread(join(mypath_part_0, onlyfiles[n]))
                gray = cv2.cvtColor(img[n], cv2.COLOR_BGR2GRAY)
